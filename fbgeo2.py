...
path = str(sys.argv[4])
url = requests.get('https://graph.facebook.com/search?limit=1000&type=place&center=%s,%s&distance=%s&fields=name,category,category_list,likes,location,picture&access_token=%s' % (latitude,longitude,distance,access_token))
